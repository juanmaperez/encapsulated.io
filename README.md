...
This site has been created with the default starter project from gatsby on https://github.com/gatsbyjs/gatsby-starter-default
...
2.  **Open the source code and start editing!**
    ...
    For editing is recommended to create a branch from develop or master, both of them must be updated in every moment and changes pushed into the repository. 
...
3.  **Deployment to production**
    ...
    For deploying you only need to run the npm deploy command after check that everything is workin properly in local
